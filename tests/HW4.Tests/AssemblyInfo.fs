...
[<assembly: AssemblyTitleAttribute("FirstSem.Tests")>]
[<assembly: AssemblyProductAttribute("FirstSem")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "FirstSem.Tests"
    let [<Literal>] AssemblyProduct = "FirstSem"
